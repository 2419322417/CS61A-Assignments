...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        """
        self.transactions.append(Transaction(self.next_ids(), self.balance, self.balance + amount))
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(self.next_ids(), self.balance, self.balance ))
