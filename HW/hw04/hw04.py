...
def balanced(m):
    ...
    if is_planet(m):
        ...
        left_value = length(left(m)) * total_mass(left_end)
        right_value = length(right(m)) * total_mass(right_end)
        return left_value == right_value and balanced(left_end) and balanced(right_end)
